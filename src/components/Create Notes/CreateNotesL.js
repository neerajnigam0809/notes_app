...
function CreateNotesL({ groupNamesParent, setGroupNamesParent, onClose }) {
  ...
  return (
    <div className="l_popup">
      <div className="l_popup_title">Create New Notes Group</div>
      <div className="l_popup_input">
      ...
      <div className="l_popup_choose_color">
        <span>Choose Color</span>
        <div className="l_popup_color">
          <div
            className={'l_popup_color_1'}
            onClick={handleColor}
          ></div>
          <div
            className={'l_popup_color_2'}
            onClick={handleColor}
          ></div>
          <div
            className={'l_popup_color_3'}
            onClick={handleColor}
          ></div>
          <div
            className={'l_popup_color_4'}
            onClick={handleColor}
          ></div>
          <div
            className={'l_popup_color_5'}
            onClick={handleColor}
          ></div>
          <div
            className={'l_popup_color_6'}
            onClick={handleColor}
          ></div>
        </div>
      </div>
      <div className="l_popup_close">
